...
/*	@RequestMapping("queryallcomment.action")
	...
	public @ResponseBody PageInfo getText(String findtext,Model model,@RequestParam(value="pn",defaultValue="1")int pn) {
		Object a=PageHelper.startPage(pn, 5);
		List<CommentVo> commentlist = goodsCommentService.queryCommentList(findtext);
		PageInfo page = new PageInfo(commentlist);
		System.out.println(page);
		model.addAttribute("page",page.getTotal());
		return page;
	}
